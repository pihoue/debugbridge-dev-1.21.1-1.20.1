...
public class DebugBridgeMod extends AbstractDebugBridgeMod {
    ...
    private static class Minecraft1211StateProvider implements GameStateProvider {
        @Override
