...
A neoforge client mod for Minecraft (1.21.1 and 1.20.1 development snapshots) that exposes game state over a local WebSocket server, plus a Vue web UI for visual inspection. Built for AI-assisted Minecraft development and debugging.
